...
CATEGORIES = [
    ("https://pakmcqs.com/category/english-literature-mcqs", 35, "English Literature"),
    ("https://pakmcqs.com/category/english-literature-mcqs/language-and-linguistics", 15, "Linguistics & Phonetics"),
    ("https://pakmcqs.com/category/english-literature-mcqs/literary-theory-and-criticism", 15, "Literary Theory & Criticism"),
    ("https://pakmcqs.com/category/english-literature-mcqs/introduction-to-literary-theory", 10, "Literary Theory & Criticism"),
    ("https://pakmcqs.com/category/english-literature-mcqs/famous-playwright-poet-and-others", 20, "Drama & Theatre"),
    ("https://pakmcqs.com/category/english-literature-mcqs/english-romantic-poetry", 15, "Classical & Romantic Poetry"),
    ("https://pakmcqs.com/category/english-literature-mcqs/modern-poetry-and-poetics", 15, "Modern & Post-Modern Poetry"),
    ("https://pakmcqs.com/category/english-literature-mcqs/the-victorian-novel", 15, "Novels, Fiction & Prose"),
    ("https://pakmcqs.com/category/english-literature-mcqs/the-gothic-novel", 10, "Novels, Fiction & Prose"),
    ("https://pakmcqs.com/category/english-literature-mcqs/american-literature", 15, "American & World Literature"),
    ("https://pakmcqs.com/category/english-literature-mcqs/restoration-eighteenth-century-drama", 12, "Drama & Theatre"),
    ("https://pakmcqs.com/category/english-literature-mcqs/ages-era-period", 15, "History of English Literature"),
    ("https://pakmcqs.com/category/english-literature-mcqs/medieval-literature-and-culture", 10, "History of English Literature"),
    ...
    ("https://pakmcqs.com/category/english-literature-mcqs/miscellaneous-literature-mcqs", 20, "English Literature"),
    ("https://pakmcqs.com/category/english-mcqs", 25, "Grammar, Vocabulary & Figures of Speech"),
    ("https://pakmcqs.com/category/pakistan-current-affairs-mcqs", 15, "General Knowledge & Pakistan Studies"),
    ("https://pakmcqs.com/category/islamic-studies-mcqs", 12, "General Knowledge & Pakistan Studies"),
    ("https://pakmcqs.com/category/everyday-science-mcqs", 12, "General Knowledge & Pakistan Studies")
]
...
def scrape_and_compile():
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        ...
        for f in as_completed(futures):
            ...
            if completed % 20 == 0 or completed == len(tasks):
                print(f"[*] Processed {completed}/{len(tasks)} pages... ({len(all_mcqs)} unique MCQs)", flush=True)
            try:
                page_items = f.result()
    ...
    print(f"\n[+] Harvesting Complete! Total Unique English Lecturer MCQs: {len(results)}", flush=True)
